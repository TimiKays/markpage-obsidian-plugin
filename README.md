...
一键将笔记（含图片）同步到 [MarkPage](https://github.com/TimiKays/MarkPage) —— 一个 Markdown 转精美图片的编辑器，让你的笔记变成适合社交媒体（小红书、Instagram、手机壁纸等）的精美视觉图。

## 安装

### 从社区插件安装（推荐）

在设置 → 社区插件中搜索 "MarkPage Sync"。
...
3. 重启应用 → 设置 → 社区插件 → 启用 **MarkPage Sync**
